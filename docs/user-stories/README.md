...
|---|---|:---:|---|---|---|
| [**US-B1**](US-B1-verified-logistics-assistant.md) | Trợ lý Logistics Xác Thực & Phân Luồng Ngữ Nghĩa | Track B1 · Tối ưu Bot Trợ lý | Học viên khóa học trên Discord | Trôi tin nhắn, bot trả lời dài dòng (tb 486 ký tự), hay phỏng đoán gây nộp bài trễ / hoang mang | 90% học viên phàn nàn bot dài dòng/đoán mò; 50% bị trễ hạn; 23/107 câu hỏi bị trôi |
| [**US-B2**](US-B2-unanswered-question-radar.md) | Radar Rà Soát Câu Hỏi Tồn & Bản Tin Ngày Cho TA | Track B2 · Công cụ hỗ trợ TA | Lab Coach / Trợ giảng trực ca | Mất 15–60p/ngày trả lời lặp lại; bỏ sót học viên stuck; bản tin cũ bị lỗi từ và thiếu link | 100% TA tốn 15–60p/ngày; 60% xác nhận trôi tin bỏ sót; 100% TA xác nhận bản tin cũ lỗi |
...
| [**US-B4**](US-B4-role-onboarding-and-permission-lock.md) | Onboarding Phân Quyền Vai Trò Khóa Cứng Lần Đầu | Track B3 · Phân quyền & Định danh | Thành viên khóa học mới | Rủi ro tự phong quyền (self-promotion), cấu hình nhầm vai trò, lọt dữ liệu điều phối | Yêu cầu bảo mật Zero Trust & RLS PostgreSQL; bảo đảm học viên chỉ nhận đúng quyền |
| [**US-B5**](US-B5-in-app-messages-triage-and-reply.md) | Quản Lý Tin Nhắn & Trả Lời Trực Tiếp Từ Ứng Dụng | Track B2 · Điều phối & Messages | Lab Coach / Trợ giảng trực ca | Mất thời gian chuyển app Discord, đọc mã JSON thô rối mắt, nguy cơ bot spam kênh chung | Tiết kiệm thời gian xử lý ticket xuống <15s; 100% không hiển thị JSON thô; trả lời đẩy thẳng vào DB |
