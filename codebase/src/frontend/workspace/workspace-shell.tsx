  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#09090b] text-[#e4e4e7] font-sans text-[13px] select-none">
      ...
      <aside className="w-[240px] flex-shrink-0 h-screen flex flex-col justify-between bg-[#121215] border-r border-[#27272a] z-40 p-3">
        ...
        {/* Bottom User Profile Section - Role is displayed statically; in-app switcher REMOVED */}
        <div className="flex flex-col gap-2 pt-3 border-t border-[#27272a]">
          <div className="p-2 rounded-lg bg-[#18181b] border border-[#27272a] flex items-center justify-between">
            <div className="flex items-center gap-2 min-w-0">
              <div className="w-7 h-7 rounded bg-[#27272a] border border-[#3f3f46] text-cyan-400 font-mono text-xs font-semibold flex items-center justify-center flex-shrink-0">
            ...
            {/* Profile Settings (Open Role Modal or Sign Out) */}
            <div className="flex items-center gap-1">
              <button
                type="button"
                onClick={() => setIsRoleModalOpen(true)}
                title="Change Database Role"
                className="text-[#71717a] hover:text-white transition p-1 text-xs font-mono"
              >
                ⚙️
              </button>
              <button
